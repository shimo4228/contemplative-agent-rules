...
**あらゆる AI エージェントが採用可能なドロップイン・アラインメントルール** — Claude Code, Cursor, GitHub Copilot, OpenClaw, OpenCode, Codex, または任意の汎用 LLM (ChatGPT, Gemini, Anthropic Claude API, Ollama, llama.cpp) で利用可能。1 ソースから多経路で採用できます。
...
OpenClaw, OpenCode, Codex などは soul-folder パターンに対応しており、起動時に personality ファイルを読み込みます。本リポジトリの [SOUL.md](SOUL.md) を soul ファイルとして配置してください:
